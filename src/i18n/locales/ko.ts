  ...
  settings: {
    ...
    advanced: {
      ...
      skipRenameLinkUpdates: {
        ...
        desc: '실험적인 기능입니다. 노트 이름을 바꾸면 그 노트를 링크하는 노트들이 새 날짜 대신 기존 날짜를 그대로 유지합니다. [[wikilink]] 형식의 링크에서만, 그리고 폴더가 아닌 단일 노트의 이름을 바꿀 때만 동작합니다. 드물게 링크만 바꾼 본인의 편집이 날짜를 갱신하지 않을 수 있습니다.',
      },
      postUpdateCommand: {
        name: '업데이트 후 명령어',
