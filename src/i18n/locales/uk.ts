...
export const STRINGS_UK: Strings = {
  ...
  settings: {
    validation: {
      propertyNameRequired: 'Введіть назву властивості.',
      counterNameCollision:
        'Ця назва вже використовується іншою властивістю вище.',
    },
    description: {
      syncIntro:
    ...
    formatting: {
      ...
      timezone: {
        ...
        invalidTimezone: 'Невідома назва часового поясу.',
      },
      numberProperties: {
    ...
    behavior: {
      ...
      changeDetection: {
        ...
        desc: 'Якщо увімкнено, дата останнього редагування записується лише тоді, коли вміст нотатки справді змінюється - це запобігає хибним оновленням від плагінів синхронізації.',
      },
      hashTrackingMode: {
      ...
      excludeKeys: {
        ...
        listHeading: 'Ігноровані властивості',
        emptyState: 'Немає ігнорованих властивостей.',
      },
    },
    filterRules: {
      name: 'Файли та теки, які пропускати',
      pageDesc:
        'Виберіть файли або папки, дати в яких ніколи не оновлюються автоматично.',
    ...
    advanced: {
      pageName: 'Додатково',
      pageDesc: 'Налаштування часу, кешу та автоматизації.',
      newFileDelay: {
      ...
      skipRenameLinkUpdates: {
        ...
        desc: 'Експериментальна функція. Після перейменування нотатки ті нотатки, що на неї посилаються, зберігають наявну дату замість нової. Працює лише з посиланнями виду [[wikilink]] і лише під час перейменування однієї нотатки, а не теки. У рідкісних випадках власна правка, що змінює лише посилання, може не оновити дату.',
      },
      postUpdateCommand: {
