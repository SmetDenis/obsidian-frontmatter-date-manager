...
export const STRINGS_PT_BR: Strings = {
  ...
  settings: {
    validation: {
      propertyNameRequired: 'Digite um nome de propriedade.',
      counterNameCollision:
        'Esse nome já está sendo usado por outra propriedade acima.',
    },
    description: {
      syncIntro:
    ...
    behavior: {
      ...
      changeDetection: {
        ...
        desc: 'Quando ativado, a data da última edição é gravada apenas quando o conteúdo da nota realmente muda - isso evita atualizações falsas de plugins de sincronização.',
      },
      hashTrackingMode: {
      ...
      excludeKeys: {
        ...
        listHeading: 'Propriedades ignoradas',
        emptyState: 'Nenhuma propriedade ignorada.',
      },
    },
    filterRules: {
      name: 'Arquivos e pastas a ignorar',
      pageDesc:
        'Escolha arquivos ou pastas que nunca recebem atualizações automáticas de data.',
    ...
    advanced: {
      ...
      skipRenameLinkUpdates: {
        ...
        desc: 'Experimental. Ao renomear uma nota, as notas que apontam para ela mantêm a data existente em vez de receberem uma nova. Só funciona com links no estilo [[wikilink]] e ao renomear uma única nota, não uma pasta. Em casos raros, uma edição sua que muda apenas um link pode não atualizar a data. Requer que "Detectar mudanças reais de conteúdo" continue ativado.',
      },
      postUpdateCommand: {
