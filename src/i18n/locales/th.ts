...
export const STRINGS_TH: Strings = {
  ...
  settings: {
    validation: {
      propertyNameRequired: 'กรอกชื่อพร็อพเพอร์ตี้',
      counterNameCollision: 'ชื่อนี้ถูกใช้โดยพร็อพเพอร์ตี้อื่นด้านบนแล้ว',
    },
    description: {
      syncIntro:
    ...
    formatting: {
      ...
      timezone: {
        ...
        invalidTimezone: 'ไม่รู้จักชื่อเขตเวลานี้',
      },
      numberProperties: {
    ...
    behavior: {
      ...
      changeDetection: {
        ...
        desc: 'เมื่อเปิดใช้งาน วันที่แก้ไขล่าสุดจะถูกเขียนเฉพาะเมื่อเนื้อหาของโน้ตเปลี่ยนแปลงจริง ซึ่งป้องกันการอัปเดตปลอมจากปลั๊กอินซิงค์',
      },
      hashTrackingMode: {
      ...
      excludeKeys: {
        ...
        listHeading: 'พร็อพเพอร์ตี้ที่ถูกละเว้น',
        emptyState: 'ไม่มีพร็อพเพอร์ตี้ที่ถูกละเว้น',
      },
    },
    filterRules: {
      name: 'ไฟล์และโฟลเดอร์ที่จะข้าม',
      pageDesc: 'เลือกไฟล์หรือโฟลเดอร์ที่จะไม่ได้รับการอัปเดตวันที่อัตโนมัติ',
      ruleCount: 'กฎ: {count}',
      descIntro:
    ...
    advanced: {
      pageName: 'ขั้นสูง',
      pageDesc: 'ตัวเลือกเกี่ยวกับเวลา แคช และระบบอัตโนมัติ',
      newFileDelay: {
      ...
      skipRenameLinkUpdates: {
        ...
        desc: 'ฟีเจอร์ทดลอง เมื่อคุณเปลี่ยนชื่อโน้ต โน้ตที่ลิงก์มาหาจะคงวันที่เดิมไว้แทนที่จะได้วันที่ใหม่ ใช้ได้เฉพาะลิงก์แบบ [[wikilink]] และเมื่อเปลี่ยนชื่อโน้ตเดียว ไม่ใช่โฟลเดอร์ ในบางกรณีที่พบไม่บ่อย การแก้ไขของคุณเองที่เปลี่ยนแค่ลิงก์อาจไม่อัปเดตวันที่',
      },
      postUpdateCommand: {
