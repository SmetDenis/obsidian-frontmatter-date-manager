...
export const STRINGS_AR: Strings = {
  ...
  settings: {
    validation: {
      propertyNameRequired: 'أدخل اسم خاصية.',
      counterNameCollision: 'هذا الاسم مستخدم بالفعل بواسطة خاصية أخرى أعلاه.',
    },
    description: {
      syncIntro:
    ...
    formatting: {
      ...
      timezone: {
        ...
        invalidTimezone: 'اسم منطقة زمنية غير معروف.',
      },
      numberProperties: {
    ...
    behavior: {
      ...
      changeDetection: {
        ...
        desc: 'عند التفعيل، يُكتب تاريخ آخر تعديل فقط عندما يتغيّر محتوى الملاحظة فعليًا، وهذا يمنع التحديثات الزائفة الناتجة عن إضافات المزامنة.',
      },
      hashTrackingMode: {
    ...
    filterRules: {
      ...
      pageDesc:
        'اختر الملفات أو المجلدات التي لا يتم تحديث تواريخها تلقائيًا أبدًا.',
      ruleCount: 'قواعد: {count}',
      descIntro:
    ...
    advanced: {
      pageName: 'متقدّم',
      pageDesc: 'خيارات التوقيت والتخزين المؤقت والأتمتة.',
      newFileDelay: {
      ...
      skipRenameLinkUpdates: {
        ...
        desc: 'ميزة تجريبية. عند إعادة تسمية ملاحظة، تحتفظ الملاحظات التي ترتبط بها بتاريخها الحالي بدلاً من الحصول على تاريخ جديد. تعمل فقط مع الروابط بنمط [[wikilink]] وعند إعادة تسمية ملاحظة واحدة، وليس مجلداً. في حالات نادرة قد لا يؤدي تعديلك الذي يغيّر رابطاً فقط إلى تحديث التاريخ.',
      },
      postUpdateCommand: {
