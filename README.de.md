...
| Experimentell: Datum nach dem Umbenennen einer Notiz nicht aktualisieren | `false` | Notizen, die auf die umbenannte Notiz verlinken, behalten ihr bisheriges Datum. Nur `[[wikilink]]`-Links und einzelne Notizen; erfordert aktivierte Änderungserkennung |
